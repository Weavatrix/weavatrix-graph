...
harness and states the output-parity contract, runtime versions, medians, and
timer-noise boundary. On its disclosed 50k-node / 149,991-edge BFS fixture,
across three independent runs, the binding measured **2.98x** faster than
Graphology on both Node 24 and Bun 1.3, while also carrying typed provenance on
every edge. The npm library is a separately released Graph product; it does not
belong to Online or MCP.
